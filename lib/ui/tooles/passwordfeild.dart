            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  labelText: widget.hasFloatingPlaceholder
                      ? widget.floatingText ?? 'password'.tr().toString()
                      : (widget.hintText ?? 'password'.tr().toString()),
                  labelStyle: widget.hintStyle ?? widget.inputStyle,
                  prefixIcon: widget.perffixIconEnabled
                      ? GestureDetector(
                          child: widget.perffixIcon ?? Icon(Icons.lock),
                        )
                      : null,
                  // Image(
